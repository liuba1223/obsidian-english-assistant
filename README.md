...
- **词典按需下载** - 可选择官方 `ecdict.csv`、`ecdict.mini.csv` 或兼容 CSV 词典
...
- **ECDICT 完整版 `ecdict.csv`**：
  [skywind3000/ECDICT](https://github.com/skywind3000/ECDICT/blob/master/ecdict.csv)
- **ECDICT 精简版 `ecdict.mini.csv`**：
  [skywind3000/ECDICT](https://github.com/skywind3000/ECDICT/blob/master/ecdict.mini.csv)
- **ECDICT 官方 Releases（StarDict / SQLite 等格式）**：
